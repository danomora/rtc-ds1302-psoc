// ======================================================================
// rtc.v generated from TopDesign.cysch
// 08/10/2021 at 16:46
...
module top ;
	...
	wire [0:0] tmpOE__dat_net;
	wire [0:0] tmpFB_0__dat_net;
	wire [0:0] tmpINTERRUPT_0__dat_net;
	electrical [0:0] tmpSIOVREF__dat_net;

	cy_psoc3_pins_v1_10
		#(.id("23ea5a8f-77be-425d-9bd2-eb1f4265ae15"),
		  .drive_mode(3'b101),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		dat
		 (.oe(tmpOE__dat_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__dat_net[0:0]}),
		  .io({Net_160}),
		  .siovref(tmpSIOVREF__dat_net),
		  .interrupt({tmpINTERRUPT_0__dat_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__dat_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("d522323a-08eb-457e-8eb0-06bd9ab28d9d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
